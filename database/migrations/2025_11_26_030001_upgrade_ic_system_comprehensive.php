...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // ========================================
        if (!Schema::hasTable('ic_hand_hygiene_observations')) {
        ...
        // ========================================
        if (!Schema::hasTable('ic_environment_checks')) {
        ...
        // ========================================
        if (!Schema::hasTable('ic_device_days')) {
        ...
        // ========================================
        if (!Schema::hasTable('ic_antibiotic_uses')) {
        ...
        // ========================================
        if (!Schema::hasTable('ic_outbreaks')) {
        ...
        if (!Schema::hasTable('ic_education_attendees')) {
        ...
        // ========================================
        if (!Schema::hasTable('ic_settings')) {
        ...
        // ========================================
        if (Schema::hasTable('ic_surveillance_logs')) {
        ...
        // ========================================
        if (Schema::hasTable('ic_incidents')) {
