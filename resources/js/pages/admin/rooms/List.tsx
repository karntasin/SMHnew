...
export default function List({ rooms, bookings, stats, currentFilter }: Props) {
            ...
            <div className="container mx-auto py-6 space-y-6">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    >
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{stats.today_bookings}</div>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{stats.active_rooms} / {rooms.length}</div>
